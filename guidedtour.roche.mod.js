...
function clrpiIntroTour(language) {
  ...
  var translations = {
    intro: {
      english: 'Welcome to the course! This is the slide area where the 5-day challenge content will be displayed. You can also click on each icon to navigate across the course.',
    ...
    menu: {
      english: 'The course menu is located here. It provides an overview of the course structure and allows you to jump to specific day of the challenge.',
